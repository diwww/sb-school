...
public class MainActivity extends AppCompatActivity {
    ...
    private Handler mUIHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            // а в месседже можно?
            mAdapter.setData((List<Note>) msg.obj);
            return true;
        }
    });
    // Handler thread for db querying
    private DBHandlerThread mHandlerThread = DBHandlerThread.getInstance(this);
    ...
    private void init() {
        ...
        mAddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mHandlerThread.addNote(mUIHandler, new Note(mTitleEditText.getText().toString(),
                        mTextEditText.getText().toString(), -1));
            }
        });
