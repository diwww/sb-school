...
import ru.gcsales.seminar6.services.ThirdService;
...
public class ThirdFragment extends Fragment {
    ...
    public void onResume() {
        ...
        getActivity().startService(ThirdService.newIntent(getActivity()));
    }
    ...
    public void onPause() {
        ...
        getActivity().stopService(ThirdService.newIntent(getActivity()));
    }
    ...
    public String getText() {
        return mButtons[1].getText().toString();
    }
